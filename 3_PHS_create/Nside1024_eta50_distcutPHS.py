    ...
    for j in range(nbin):
        ...
        for ii in range (0,101):
            for jj in range (0,101):
                # Here is where one can constrain whether to see inner or outer 
                if j <= Get_Dis(51, 51, ii, jj) and Get_Dis(51, 51, ii, jj) < j+1 and Get_Dis(51,51,ii,jj) > 6:# Outer rim
                #if j <= Get_Dis(51, 51, ii, jj) and Get_Dis(51, 51, ii, jj) < j+1 and Get_Dis(51,51,ii,jj) <= 6: # Inner peak
...
file_name = str(num_sigs)+'_partial2_eta50PHS'
